...
func listenToConsumerMessages(connection net.Conn, consumer *channelconsumer.Consumer, store channelconsumer.Storage, messageQueue channelconsumer.MessageStorage, persist persistence.Persistence, file *os.File, channel channelconsumer.ChannelStorage, sqlite sqlite.Persistence, database *sql.DB) error {
